...
private:
	...
	map<string, map<int, map<int, TH1I*>>> psi_original_dists;  // Distribution of event planes before flattening [ep_type][centrality][run_key]
	map<string, map<int, map<int, TH1I*>>> psi_flat_dists;  // Distribution of event planes after flattening [ep_type][centrality][run_key]
};
